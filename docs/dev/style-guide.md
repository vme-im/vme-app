...
自嘲、抽象、玩梗，但**不促销腔**（不要「限时」「火爆」「快来」），也**不报纸腔**（没有「本报」
「刊」「版面」）。现有 slogan（「不疯狂不星期四」「V ME 50」「精神状态遥遥领先」等）尽量复用，
别自己发明促销话术。全站统一口径示例：
...
| 首页三栏     | 精选好活                              |
| 最新收录     | 新鲜出炉                              |
| 高赞排行     | 被 V 爆的 / 详情页热贴纸「被 V 爆了」 |
| 高产作者     | 文案鬼才（排行页：文案鬼才排行）      |
| 作者页页头   | 鬼才档案                              |
| 投稿页页头   | 交作业 / 投稿须知                     |
| 状态页页头   | 后厨监控                              |
| 详情页互动区 | 表个态                                |
| 详情页作者档 | 谁写的                                |
| 分页         | 上一页 / 下一页 / 第 X 页 · 共 Y 页   |
